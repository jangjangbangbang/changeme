...
* **State Management:** Separate ephemeral state and app state. Use Riverpod state
...
* **MVVM Clean with Architecture:** When a more robust solution is needed, structure the app using the
  Model-View-ViewModel (MVVM) pattern with Clean Architecture.
